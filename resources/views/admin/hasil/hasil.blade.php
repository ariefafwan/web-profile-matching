                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <a href="{{ route('tambahhasil') }}" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbspTambah Data</a>
                            <!-- Button Import modal -->
                            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#importmodal"><i class="bi bi-arrow-down-circle"></i>&nbspImport Hasil</button>
                            @include('admin.hasil.importhasil')
                            <a href="{{ route('hasil.export') }}" class="btn btn-success" target="_blank"><i class="fa fa-download" aria-hidden="true"></i>&nbspDownload/Export Hasil</a>
                        </div>
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body">
