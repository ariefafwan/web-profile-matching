                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <a href="{{ route('pertanyaan.create') }}" class="btn btn-primary">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i>&nbspTambah Data</a>
                            <!-- Button Import modal -->
                            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#importmodal"><i class="bi bi-arrow-down-circle"></i>&nbspImport Bobot Pertanyaan</button>
                            @include('admin.pertanyaan.importpertanyaan')
                            <a href="{{ route('bobotpertanyaan.export') }}" class="btn btn-success" target="_blank"><i class="fa fa-download" aria-hidden="true"></i>&nbspDownload/Export Pertanyaan</a>
                        </div>
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body">
